...
```
dependencies {
    implementation(name: 'quicklogin-release', ext: 'aar') // aar包具体名称请以官网下载下来为准
    implementation(name: 'CTAccount_sdk_api', ext: 'aar')  // aar包具体名称请以官网下载下来为准
